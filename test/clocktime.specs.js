...
describe('Clock Time Model: TSMT$ClockModel', function () {
    ...
    it('factory test #2', function () {
        clock.is24Hour = NOT_24_HOUR;
        clock.update(10, 53, 0, AM);
        var clock2 = ClockTimeModel_1.TSMT$ClockTimeModel.factory(3, 57, 0, NOT_24_HOUR, PM);
    ...
    it('factory test #3', function () {
        clock.is24Hour = NOT_24_HOUR;
        clock.update(10, 53, 0, AM);
        var clock2 = ClockTimeModel_1.TSMT$ClockTimeModel.factory(3, 33, 0, NOT_24_HOUR, PM);
        expect(clock.toString()).to.equal('10:53 AM');
    ...
    it('factory test #4', function () {
        clock.is24Hour = NOT_24_HOUR;
        clock.update(12, 50, 0, AM);
        var clock2 = ClockTimeModel_1.TSMT$ClockTimeModel.factory(12, 34, 0, NOT_24_HOUR, PM);
    ...
    it('factory test #5', function () {
        clock.is24Hour = NOT_24_HOUR;
        clock.update(3, 42, 0, PM);
        var clock2 = ClockTimeModel_1.TSMT$ClockTimeModel.factory(6, 18, 0, NOT_24_HOUR, AM);
    ...
    it('factory test #6', function () {
        clock.is24Hour = NOT_24_HOUR;
        clock.update(12, 0, 0, PM);
        var clock2 = ClockTimeModel_1.TSMT$ClockTimeModel.factory(12, 0, 0, NOT_24_HOUR, PM);
    ...
    it('factory test #7', function () {
        clock.is24Hour = NOT_24_HOUR;
        clock.update(12, 0, 0, PM);
        var clock2 = ClockTimeModel_1.TSMT$ClockTimeModel.factory(12, 0, 0, NOT_24_HOUR, AM);
        expect(clock.toString()).to.equal('12:00 PM');
    ...
    it('(24-hour) elapsed time #1', function () {
        clock.is24Hour = IS_24_HOUR;
        clock.update(19, 17, 20);
        var clock2 = new ClockTimeModel_1.TSMT$ClockTimeModel();
    ...
    it('(24-hour) elapsed time #2', function () {
        clock.is24Hour = IS_24_HOUR;
        clock.update(10, 20);
        var clock2 = new ClockTimeModel_1.TSMT$ClockTimeModel();
        clock2.is24Hour = NOT_24_HOUR;
    ...
    it('subtraction test #1', function () {
        clock.is24Hour = NOT_24_HOUR;
    ...
    it('subtraction test #3', function () {
        clock.is24Hour = NOT_24_HOUR;
